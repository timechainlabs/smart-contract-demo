...
if(!process.env.NEUCRON_PASSWORD) {
...
const privateKey = bsv.PrivateKey.fromWIF(process.env.NEUCRON_PASSWORD || '')
...
async function main() {
    ...
    console.log(`Smartdemo contract deployed: ${deployTx.id}`)
}
